...
from .views import GenerateTopicsView, SignupView,UpdatePasswordView, OtpVerificationView,OTPRetryView,UploadDocumentView,ProcessFileView,ResetPasswordView
...
urlpatterns = [
    ...
    path("topics-list/<int:file_id>/", GenerateTopicsView.as_view(), name="topics_list"),
